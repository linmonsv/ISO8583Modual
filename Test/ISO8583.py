...
"""
    ...
    def __setBitTypeA(self, bit, value):
        ...
        if self.getBitValueType(bit) == 'ans' or self.getBitValueType(bit) == 'a':
            self.BITMAP_VALUES[bit] = binascii.b2a_hex(value.zfill(self.getBitLimit(bit)).encode("utf-8")).decode("utf-8")
